...
export const en = {
  ...
  "inspect.ball.give": "Give the ball",
  "inspect.ball.hint":
  ...
  "inspect.highlight.pick": "Choose the highlight colour",
  "inspect.switchSide": "Move to the other side",
  ...
  "inspect.makeKeeper": "Make goalkeeper",
  ...
  "draw.color": "Colour",
  "draw.color.pick": "Choose the colour to draw in",
  "draw.dash.solid": "Run",
  ...
  "draw.highlight": "Highlight on this scene",
  "draw.align": "Line alignment",
  "draw.align.left": "Align left",
  "draw.align.center": "Centre",
  "draw.align.right": "Align right",
  "draw.unhighlight": "Stop highlighting on this scene",
  "draw.keepLit": "Keep out of the dark on every scene",
  "draw.letDim": "Let it dim with the rest of the board",
  ...
  "draw.bg.pick": "Choose the label's background",
  ...
  "links.highlight": "Highlight link on this scene",
  ...
  "links.colour.pick": "Choose the colour of {name}",
  ...
  "account.delete.message": "This permanently deletes your account and everything in it: projects, boards, squads, and every link you published, which stop working for anyone who has them. It cannot be undone. A board in progress in this browser is cleared too; anything you exported or shared as a #d= link is untouched.",
  "account.delete.typeEmail": "Type {email} to confirm.",
  "account.delete.confirm": "Delete my account",
  "account.delete.busy": "Deleting…",
  "account.delete.failed": "The account was not deleted. Please try again.",
  "account.error.invalid_credentials": "Wrong email or password.",
  "account.error.invalid_request": "Check the email address and try again.",
  "account.error.invalid_token": "That link has expired or was already used. Ask for a new one.",
  "account.error.rate_limited": "Too many attempts. Wait a minute and try again.",
  "account.error.captcha_failed": "The bot check did not pass. Please try again.",
  "account.signIn.or": "or with email",
  "account.email": "Email",
  "account.password": "Password",
  "account.password.new": "New password",
  "account.password.tooShort": "Use at least {min} characters.",
  "account.password.busy": "Working…",
  "account.password.submit.signIn": "Sign in",
  "account.password.submit.register": "Create account",
  "account.password.submit.forgot": "Send reset link",
  "account.password.submit.reset": "Set new password",
  "account.password.toRegister": "Create an account",
  "account.password.toForgot": "Forgot password?",
  "account.password.toSignIn": "Back to sign in",
  "account.password.resetFor": "Choose a new password for {email}.",
  "account.password.sentVerify": "Check {email} for a link to confirm your address. It expires in 24 hours.",
  "account.password.sentReset": "If {email} has an account, a reset link is on its way. It expires in 1 hour.",
  "account.password.verifying": "Confirming your email…",
