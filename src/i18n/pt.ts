...
export const pt: Dictionary = {
  ...
  "account.delete.message": "Isto elimina permanentemente a sua conta e tudo o que contém: projetos, quadros, planteis e todas as ligações que publicou, que deixam de funcionar para quem as tiver. Não pode ser desfeito. Um quadro em curso neste navegador também é limpo; o que exportou ou partilhou como ligação #d= não é afetado.",
  "account.delete.typeEmail": "Escreva {email} para confirmar.",
  "account.delete.confirm": "Eliminar a minha conta",
  "account.delete.busy": "A eliminar…",
  "account.delete.failed": "A conta não foi eliminada. Tente novamente.",
  "account.error.invalid_credentials": "Email ou palavra-passe errados.",
  "account.error.invalid_request": "Verifique o endereço de email e tente novamente.",
  "account.error.invalid_token": "Essa ligação expirou ou já foi usada. Peça uma nova.",
  "account.error.rate_limited": "Demasiadas tentativas. Aguarde um minuto e tente novamente.",
  "account.error.captcha_failed": "A verificação anti-bot falhou. Tente novamente.",
  "account.signIn.or": "ou com email",
  "account.email": "Endereço de email",
  "account.password": "Palavra-passe",
  "account.password.new": "Nova palavra-passe",
  "account.password.tooShort": "Use pelo menos {min} caracteres.",
  "account.password.busy": "A processar…",
  "account.password.submit.signIn": "Entrar",
  "account.password.submit.register": "Criar conta",
  "account.password.submit.forgot": "Enviar ligação",
  "account.password.submit.reset": "Definir nova palavra-passe",
  "account.password.toRegister": "Criar uma conta",
  "account.password.toForgot": "Esqueceu a palavra-passe?",
  "account.password.toSignIn": "Voltar ao início de sessão",
  "account.password.resetFor": "Escolha uma nova palavra-passe para {email}.",
  "account.password.sentVerify": "Consulte {email}: enviámos uma ligação para confirmar o endereço. Expira em 24 horas.",
  "account.password.sentReset": "Se {email} tiver conta, a ligação para redefinir está a caminho. Expira em 1 hora.",
  "account.password.verifying": "A confirmar o seu email…",
